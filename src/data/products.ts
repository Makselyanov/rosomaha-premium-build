...
export const products: Product[] = [
  ...
  },
  {
    id: 'rosomaha-base',
    slug: 'rosomaha-base',
    name: 'Росомаха (базовая модель)',
    category: 'classic',
    categoryName: 'Классические модели',
    basePrice: 1100000,
    priceFormatted: 'от 1 100 000 ₽',
    available: true,
    ...
    description: 'Базовая модель снегоболотохода Росомаха. Оптимальный выбор для начинающих с отличным соотношением цена/качество.',
  },
  {
    id: 'pikap-18l',
    slug: 'rosomaha-pikap-18l',
    name: 'Росомаха Пикап 1,8л',
    category: 'pickup',
    categoryName: 'Пикапы',
    basePrice: 2350000,
    priceFormatted: 'от 2 350 000 ₽',
    available: true,
    badge: 'new',
    ...
    specs: {
      ...
      power: '140',
      axles: 'УАЗ',
      configuration: 'Пикап 1.8л',
    },
    baseEquipment: standardPlusEquipment,
    description: 'Пикап с мощным двигателем 1.8 литра для серьёзных грузоперевозок в экстремальных условиях.',
  },
  {
    id: 'pikap-toyota',
    slug: 'rosomaha-pikap-toyota',
