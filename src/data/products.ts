...
export const classicVariants: ProductVariant[] = [
  ...
  { id: 'pickup-uaz-timken', name: 'Пикап (УАЗ Тимкен)', slug: 'snegobolotokhod-rosomakha-komplektatsiya-pikap-s-dvs-1nz-fe-1-5-litra-s-mostami-uaz-timken', price: 1800000, priceFormatted: 'от 1 800 000 ₽' },
